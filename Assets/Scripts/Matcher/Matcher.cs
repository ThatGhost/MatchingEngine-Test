...
public class Matcher
{
    ...
    private const float m_prefrenceScalar = 0.40f;
    private const float m_distanceScalar = 0.40f;
    private const float m_educationScalar = 0.20f;
    private const float m_hiddenPrefrenceScalar = 0.40f;
